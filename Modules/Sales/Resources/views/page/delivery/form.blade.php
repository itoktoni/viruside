...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_delivery_date_invoice') ? 'has-error' : ''}}">
        {!! Form::text('sales_delivery_date_invoice', $model->sales_delivery_date_invoice ?? date('Y-m-d'), ['class' =>
        'form-control date']) !!}
        {!! $errors->first('sales_delivery_date_invoice', '<p class="help-block">:message</p>') !!}
    </div>

</div>

<div class="form-group">
{!! Form::label('name', 'Delivery code', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('sales_delivery_code_do') ? 'has-error' : ''}}">
        {!! Form::text('sales_delivery_code_do', $model->sales_delivery_code_do ?? '', ['class' =>
        'form-control']) !!}
        {!! $errors->first('sales_delivery_code_do', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', 'Purchase code', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('sales_delivery_code_po') ? 'has-error' : ''}}">
        {!! Form::text('sales_delivery_code_po', $model->sales_delivery_code_po ?? '', ['class' =>
        'form-control']) !!}
        {!! $errors->first('sales_delivery_code_po', '<p class="help-block">:message</p>') !!}
    </div>
