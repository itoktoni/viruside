...
class Delivery extends Model
{
    ...
    public $datatable = [
        ...
        'sales_delivery_date_invoice'                => [false => 'Order Date'],
    ...
    'sales_delivery_date_invoice' => 'datetime:Y-m-d',
  ];
    ...
    public static function boot()
    {
        ...
        // parent::saving(function ($model) {
        //     $model->sales_delivery_date_invoice = $model->sales_delivery_date_invoice->format('Y-m-d H:i:s');
        // });
    }
}